...
quick : $(QUICKTARGS) 
	head -4 tests.md5 > tests.md5.quick
	md5sum -c tests.md5.quick
...
ocean_hgrid_res0.5_equenh.nc: 
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.5_equenh.nc -r 2 --south_cutoff_row 130 --no_changing_meta --write_subgrid_files --enhanced_equatorial
ocean_hgrid_res0.25.nc:
