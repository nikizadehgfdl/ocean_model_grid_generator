...
ocean_hgrid_res0.5_MIDAS.nc:
	...
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.5_MIDAS.nc -r 2 --rdp 0 --south_cutoff_row 130 --reproduce_MIDAS_grids --no_changing_meta
...
ocean_hgrid_res0.25_MIDAS.nc:
	#module swap python/2.7.3_workstation On gfdl pan
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.25_MIDAS.nc -r 4 --south_cutoff_row 81 --reproduce_MIDAS_grids --no_changing_meta
	#nccmp -d /archive/gold/datasets/OM4_025/mosaic.v20170622.unpacked/ocean_hgrid.nc ocean_hgrid_res0.25_MIDAS.nc
ocean_hgrid_res0.25.nc:
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.25.nc -r 4 --south_cutoff_row 81 --no_changing_meta
ocean_hgrid_res0.125.nc:
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.125.nc -r 8 --write_subgrid_files --no_changing_meta
ocean_hgrid_res0.125_old.nc:
	#module swap python/3.6.4 On gfdl pan
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.125_old.nc -r 8 --reproduce_old8_grids --no_changing_meta
ocean_hgrid_res0.5_equenh.nc: 
	time ./ocean_grid_generator.py $(DEBUG) -f ocean_hgrid_res0.5_equenh.nc -r 2 --rdp 0 --south_cutoff_row 132 --no_changing_meta --write_subgrid_files --enhanced_equatorial
